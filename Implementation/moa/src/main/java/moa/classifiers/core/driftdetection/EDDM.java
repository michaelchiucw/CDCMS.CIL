...
public class EDDM extends AbstractChangeDetector {
    ...
    /**
     * michaelchiucw: Changed Min_inst, warning_level, outcontrol_level to be user's options.
     */
    ...
    private double FDDM_OUTCONTROL;

    private double FDDM_WARNING;

    private double FDDM_MINNUMINSTANCES;
    ...
    public void resetLearning() {
        ...
        this.estimation = 0.0;
        this.FDDM_MINNUMINSTANCES = this.minNumInstancesOption.getValue();
        this.FDDM_WARNING = this.warningLevelOption.getValue();
        this.FDDM_OUTCONTROL = this.outcontrolLevelOption.getValue();
    }
