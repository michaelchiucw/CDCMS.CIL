...
public class TestCar extends AbstractClassifier implements MultiClassClassifier {
...
//		System.out.println("Before: " + moaInstances.toString());
...
//		System.out.println("After: " + moaInstances.toString());
